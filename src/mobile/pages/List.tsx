...
export default function ListPage({ listId: listIdProp }: ListPageProps = {}) {
      ...
      >
        ...
        <div
          style={{
            ...
            bottom: 0,
            overflowY: 'auto',
            paddingTop: `calc(${safeAreaTop} + 160px)`,
            paddingLeft: '16px',
            paddingRight: '16px',
          }}
        >
  ...
  return (
    ...
    >
      ...
      >
        {/* iOS-style Navigation Header - Sticky glass effect */}
        <div
          ref={headerRef}
          style={{
            position: 'sticky',
      ...
      {/* Main Content - min-height ensures overscroll bounce even with few items */}
      <div className="w-full max-w-lg mx-auto" style={{ paddingLeft: '8px', paddingRight: '8px', paddingBottom: '180px', minHeight: 'calc(100% + 1px)' }}>
        <ListContainer
          items={itemTree}
          newItemId={newItemId}
