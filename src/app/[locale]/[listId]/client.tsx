...
export default function ListPageClient({ listId }: ListPageClientProps) {
  ...
  const [sourceSite, setSourceSite] = useState<SourceSiteInfo | null>(null);
  ...
  // Fetch source site info for branded lists
  useEffect(() => {
    if (!list?.source_site_id || !list?.source_url) return;
    ...
    fetchSourceSite();
  }, [list?.source_site_id, list?.source_url]);
  ...
  return (
    <div className="min-h-screen flex flex-col items-center" style={{ backgroundColor: 'var(--bg-primary)' }}>
      ...
      {/* Branded source bar for embedded lists */}
      {sourceSite && (
        <div
          style={{
            width: '100%',
