...
export default function ListPageClient({ listId }: ListPageClientProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center" style={{ backgroundColor: 'var(--bg-primary)' }}>
      ...
      >
        <div className="w-full max-w-lg mx-auto" style={{ paddingLeft: '8px', paddingRight: '8px' }}>
      ...
      <div className="w-full max-w-lg pb-16" style={{ paddingTop: '16px', paddingLeft: '8px', paddingRight: '8px' }}>
