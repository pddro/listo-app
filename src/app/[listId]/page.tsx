...
export default function ListPage() {
  ...
  const { lists: savedLists, addList: addSavedList, updateList: updateSavedList } = useRecentListsWeb();
      ...
      <div className="w-full max-w-lg pb-16" style={{ paddingTop: '32px', paddingLeft: '8px', paddingRight: '8px' }}>
        ...
        {showShareView ? (
          <div style={{ paddingTop: '16px' }}>
            ...
            {/* Add to my lists button (if not already saved) */}
            {!isListSaved && !justAddedToMyLists && (
              <button
                onClick={handleAddToMyLists}
                className="w-full flex items-center gap-3 py-3 px-4 rounded-lg mb-4 transition-all duration-150"
                style={{
            ...
            {justAddedToMyLists && (
              <div
                className="w-full flex items-center gap-3 py-3 px-4 rounded-lg mb-4"
                style={{
                  backgroundColor: 'var(--primary-pale)',
                  border: '1px solid var(--primary)',
                }}
        ...
        {showStyleReminder && !showShareView && (
          ...
          >
            ...
            >
              ...
              {/* Text - same styling as item text */}
              <span style={{ color: 'var(--text-primary)' }}>
                🖌️ Write style: + describe to customize your list
              </span>
            </div>
          </div>
        )}
