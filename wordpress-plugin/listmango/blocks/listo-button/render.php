...
$color  = ! empty( $attributes['color'] ) ? sanitize_hex_color( $attributes['color'] ) : get_option( 'listmango_button_color', '#FF6B35' );
$radius = isset( $attributes['radius'] ) && $attributes['radius'] >= 0 ? absint( $attributes['radius'] ) : absint( get_option( 'listmango_button_radius', 8 ) );
